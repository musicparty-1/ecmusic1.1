...
async function main() {
  ...
  // 4. Crear Evento de Lanzamiento (Pre-Lanzamiento)
  ...
  // Copiar canciones del template al evento
  ...
  const catalog = [
    ...
    // Rock Internacional (clásico y moderno)
